...
public:
  ...
  // enable trace access for a specific address
  ...
  // get the raw memory array for a specific address
  ...
  tb_mem_record records_pop(void) {
    tb_mem_record v = m_accesses.front();
    m_accesses.pop();
    return v;
  }
